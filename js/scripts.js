...
// fias fields
(function () {
    if($(document).find('#get-prize').length > 0) {
        var $container = $(document.getElementById('get-prize'));
        ...
        $()
            ...
            .add($building)
            .fias({
                parentInput: $container.find('.popup-form'),
                verify: true,
                select: function (obj) {
        ...
        function addressUpdate() {
            // var address = $.fias.getAddress('#form-get-prize');
            ...
            $.fias.getAddress('#form-get-prize', function (objs) {
                    ...
                    if ($.type(obj) === 'object') {
                        switch (obj.contentType) {
                            ...
                            case $.fias.type.district:
                                $district.val(obj.typeShort + '.' + ' ' + obj.name);
                                break;
                            ...
                            case $.fias.type.building:
                                $building.val(obj.typeShort + '.' + ' ' + obj.name);
                                break;
                        }
                    }
                    else {
